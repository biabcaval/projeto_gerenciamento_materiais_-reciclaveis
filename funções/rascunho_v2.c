...
void CadastroMaterial(material *materiais, int contador, fornecedor *lista_forne, int ind_forne, ponto_coleta *lista_pontos, int ind_ponto)
{
    ...
    switch (tipo_material)
    {
        case 'a':
            ...
            scanf("%d %d %d", &lista_forne[ind_forne].materiais[contador].data_registro.dia, &lista_forne[ind_forne].materiais[contador].data_registro.mes, &lista_forne[ind_forne].materiais[contador].data_registro.ano);
                ...
                printf("\nDigite a data em que a coleta foi feita (Escreva: DD MM AAAA): ");
            scanf("%d %d %d", &lista_pontos[ind_ponto].materiais[contador].data_registro.dia, &lista_pontos[ind_ponto].materiais[contador].data_registro.mes, &lista_pontos[ind_ponto].materiais[contador].data_registro.ano);
            }
